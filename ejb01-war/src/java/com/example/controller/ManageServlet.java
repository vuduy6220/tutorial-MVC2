...
import com.example.session.EmployeesFacadeLocal;
...
public class ManageServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String empidString = request.getParameter("id");
        int empidInteger = Integer.parseInt(empidString);
        String firstName = request.getParameter("firstName");
        String lastName = request.getParameter("lastName");
        String email = request.getParameter("email");
        Employees employees = new Employees(empidInteger, firstName, lastName, email);
        ...
        if(action.equalsIgnoreCase("ADD")) {
            ...
            employees = employeesFacade.getEmployeeId(empidInteger);
            request.setAttribute("employee", employees);
        }
        request.setAttribute("getAllEmployee", employeesFacade.findAll());
